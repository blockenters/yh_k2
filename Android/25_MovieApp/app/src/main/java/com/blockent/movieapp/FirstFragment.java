...
public class FirstFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnCnt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // 1. 버튼의 색을 바꿔준다.
                btnCnt.setTextColor(Color.parseColor("#2196F3"));
                btnAvg.setTextColor(Color.parseColor("#A3A6AA"));
                // 2. 네트워크로부터 데이터를 새로 받아온다. 정렬은 cnt 로
                order = "cnt";
                getNetworkData();
            }
        });
        ...
        btnAvg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // 1. 버튼의 색을 바꿔준다.
                btnCnt.setTextColor(Color.parseColor("#A3A6AA"));
                btnAvg.setTextColor(Color.parseColor("#2196F3"));
                // 2. 네트워크로부터 데이터를 새로 받아온다. 정렬은 avg 로
                order = "avg";
                getNetworkData();
            }
        });
    ...
    private void getNetworkData() {
        ...
        Call<MovieList> call = api.getMovieList(offset, limit, order);
